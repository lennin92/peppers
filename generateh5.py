    ...
    for row in reader:
        ...
        try:
            ...
            if len(pngs_train)>=batch_size:
                ...
                pngs_train = []
                print("GENERATED TRAIN H5 %s" % (h5_path + "train.h5." + str(count_trainh5),))
                log.info("GENERATED TRAIN H5 %s" % (h5_path + "train.h5." + str(count_trainh5),))
                count_trainh5 += 1
            ...
            if len(pngs_test) >= batch_size:
                ...
                pngs_test = []
                print("GENERATED TEST H5 %s" % (h5_path + "test.h5." + str(count_testh5),))
                log.info("GENERATED TEST H5 %s" % (h5_path + "test.h5." + str(count_testh5),))
                count_testh5 += 1
