...
def mri_to_png(mri_file, png_file):
    ...
    # Rescaling grey scale between 0-255Q
    image_2d_scaled = []
    for row in image_2d:
        row_scaled = []
        for col in row:
...
if __name__ == '__main__':
    ...
    # EJECUTAR python scripts/dicom2png.py -f <<CARPETA_DICOMS>> <<CARPETA_PNGS>>

    # CREACION DE DATASET:
    # convert_imageset --shuffle  /path/to/jpegs/  /path/to/csv  /path/to/lmdb/train_lmdb